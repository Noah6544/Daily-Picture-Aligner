...
#VARIABLES
path = "C:\\Users\\Noah\'s Marc P. 4648\\Pictures\\DAILY PIC\\"
pictures = []
...
#writes list to file, this is because the time to recreate the list every execution is repetive and computationally expensive.
